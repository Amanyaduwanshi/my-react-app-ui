...
function Register() {
  ...
  const formValidation=()=>
  {
      ...
      {
             if(address.length==0){
              setNameError("PLEASE ENTER ADDRESS !");
              setTimeout(()=>{
                  setNameError("");    
                },3000)
         }    
      ...
      const passwordValidation=(password)=>
      {
               ...
               if(password.length==0 || password.length<5 || password.length>10){
                  setNameError("PLEASE PASSWORD ENTER MINIMUM 5 DIGIT !");
                  setTimeout(()=>{
                      setNameError("");    
                    },3000)
               }    
      ...
      const mobileValidation=(mobile)=>{ 
          if(mobile.length==0 || mobile.length<10 || mobile.length>10 ){
             setNameError("PLEASE 10 DIGIT NUMBER IS REQUIRE !");
             setTimeout(()=>{
              setNameError("");    
            },3000)
         }    
       ...
       function emailValidation(email)
      {
          if(validator.isEmail(email)){
              mobileValidation(mobile)  ;
                  ...
                  setNameError("PLEASE VALID EMAIL ADDRESS ENTER !");
              setTimeout(()=>{
                  setNameError("");    
                },3000)
            }
      ...
      const nameValidation=(name,event)=>
      {
              if(name.length==0) {
                 setNameError("PLEASE NAME ENTER !");
                 setTimeout(()=>{
                  setNameError("");    
                },3000)
              }    
